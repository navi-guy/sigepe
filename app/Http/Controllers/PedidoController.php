...
class PedidoController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pedidos.create.index', compact(self::PRODUCTO,'date','cod_pedido'));
    }
    ...
    {
        $pedido = $pedido->load(self::PRODUCTO);
        $productos = Producto::all();
        return view('pedidos.edit.index', compact(self::PRODUCTO,'pedido'));
    }
