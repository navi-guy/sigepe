...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('adminlte/datatable/DataTables-1.10.21/css/datatables.bootstrap.min.css') }}" />
                    ...
                    @if (Auth::user()->role_id == 2 || Auth::user()->role_id == 1)
                        <li id="treeview-proveedores" class="treeview">
                            ...
                            <ul class="treeview-menu" id="treeview-menu-proveedores" style="display: none;">
                                <li id="sidebar-btn-proveedores"><a href="{{ route('proveedores.index') }}"><i
                                            class="fa fa-th-large"></i>Proveedores</a></li>
                                ...
                                @if (Auth::user()->role_id == 3)
                                    <li id="sidebar-btn-evaluar-pedidos"><a
                                            href="{{ route('revisarPedidos.index') }}"><i
                                                class="fa fa-check-square"></i>Evaluación de pedidos</a></li>
                                @endif
                                @if (Auth::user()->role_id == 4)
                                    <li id="sidebar-btn-ejecutar-pedidos"><a
                                            href="{{ route('seguirPedidos.index') }}"><i
                                                class="fa fa-cogs"></i>Ejecución de Pedidos</a></li>
                                @endif
                            </ul>
                        </li>
                    @endif
                    @if (Auth::user()->role_id == 1)
                        <li id="treeview-usuarios" class="treeview">
                            ...
                            <ul class="treeview-menu" style="display: none;">
                                <li id="sidebar-btn-roles-usuarios"><a href="{{ route('trabajadores.index') }}"><i
                                            class="fa fa fa-user"></i>Roles de usuario</a></li>
