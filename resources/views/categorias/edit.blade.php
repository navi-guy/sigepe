              ...
              <div class="box-body">
                <div class="form-group @error('nombre') has-error @enderror">
                  ...
                  <input id="nombre-edit" type="text" class="form-control"
                          name="nombre" placeholder="Ingrese la categoría" required  pattern="^[-a-zA-Z0-9-()]+(\s+[-a-zA-Z0-9-()]+)*$"  minlength="3" maxlength="64" title="La categoria puede contener letras y/o numeros, no debe comenzar con espacios en blanco">
                  @error('nombre')
